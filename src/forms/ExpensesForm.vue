...
const expenseCategories = [
  ...
  'Подписки (сервисы, журналы)',
  'Обеды на работе или в учебе',
  'Канцелярия и офисные принадлежности',
  ...
  'Салон красоты (стрижка, маникюр)',
  'Товары для детей',
  'Такси и аренда авто',
  'Семейные мероприятия',
  'Профессиональное развитие (конференции, тренинги)',
  'Парковка и штрафы',
  'Иностранные языки',
